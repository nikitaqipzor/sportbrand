...
func TestLogSetValidationOverHTTP(t *testing.T) {
	...
	cases := []struct {
		...
		{"weight 999.994 rounds down and is stored", func(b map[string]any) { b["weightKg"] = 999.994 }, http.StatusCreated},
		{"weight 1000.004 rounds down to the bound", func(b map[string]any) { b["weightKg"] = 1000.004 }, http.StatusCreated},
		{"weight 1000.006 rounds up past the bound", func(b map[string]any) { b["weightKg"] = 1000.006 }, http.StatusUnprocessableEntity},
